    ...
    <div className="App">
      ...
      <Navbar className='header_bg'>
        ...
        <Container>
          ...
          <Navbar.Brand onClick={() => {navigate('/')}}><img src="https://Pseheyon.github.io/zz/img/main/logo_header.png" alt=''></img></Navbar.Brand>
          <Nav >

            <Nav.Link >베스트</Nav.Link>

            <Nav.Link >제품 구매하기</Nav.Link>
            <Nav.Link onClick={() => {navigate('/cart')}}><img src="https://Pseheyon.github.io/zz/img/main/cart.png" alt=''></img></Nav.Link>
